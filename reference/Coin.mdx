...
<ParamField path="contracts/Coin.sol" type="string">
  The main stablecoin contract file
</ParamField>
...
**Parameters:**
- `_minter`: Address authorized to mint new tokens
...
Creates new tokens and assigns them to the specified address. Can only be called by the designated minter.
...
**Requirements:**
- `msg.sender` must be the designated minter address
...
**Parameters:**
- `spender`: Address whose allowance should be increased
- `addedValue`: Amount to add to current allowance

**Returns:**
- `bool`: Always returns true on successful increase
...
**Parameters:**
- `spender`: Address whose allowance should be decreased
- `subtractedValue`: Amount to subtract from current allowance

**Returns:**
- `bool`: Always returns true on successful decrease

**Requirements:**
- Current allowance must be greater than or equal to subtractedValue
...
Returns the address authorized to mint new tokens.

**Returns:**
- `address`: Designated minter address
