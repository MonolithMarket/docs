...
Monolith's core protocol contracts have been reviewed across four independent human-led security engagements: a private audit by Electisec, an initial private assessment by ChainSecurity, a public audit contest on Sherlock, and a re-audit by ChainSecurity covering all subsequent protocol changes. Additional AI-assisted reviews (Sherlock AI, Nemesis, Zellic v12) were also run. All of these reports are published and linked on the Audits page.
