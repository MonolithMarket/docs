...
Monolith's core contracts have been independently reviewed by multiple security firms before and after deployment. All findings from completed engagements have been addressed by the development team. Published reports are linked in the table below (four human-led engagements plus three AI-assisted reviews).
...
ChainSecurity conducted a re-audit of the Monolith protocol covering material changes made since their initial October 2025 review, including updates introduced across multiple iterative code versions. The engagement incorporated a final audit slot on March 23, 2026. The final report is published and linked in the table above.
